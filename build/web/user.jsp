...
<html>
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a style="margin: 20px;color: white" class="btn btn-info" href="${home}">Home</a></li>
                        </ul>
            ...
            <c:url value="/user/order/search" var="userSearch"></c:url>
            <form style="margin-left: 100px;margin-bottom: 30px" onsubmit="return checkSearch()"  action="${userSearch}" method="GET">
                ...
                <c:url value="/user/detail" var="all"></c:url>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <c:choose>
                            ...
                            <c:when test="${requestScope.listOrders.size()>0}">
                            <p>Đã tìm thấy ${requestScope.listOrders.size()} kết quả </p>
